    ...
    <footer className="footer">
      ...
      <div className="footer-container">
        <div className="footer-brand">
          <a className="brand-logo" href="https://github.com/HAREESSHP" target="_blank" rel="noopener noreferrer" aria-label="HAREESSHP GitHub profile">
        ...
        <div className="footer-contact">
          ...
          <ul>
            <li>
              <svg className="icon" viewBox="0 0 24 24" width="18" height="18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 5.5C3 4.67 3.67 4 4.5 4H7c.55 0 1 .45 1 1v2.5c0 .83-.67 1.5-1.5 1.5H6C4.34 9 3 7.66 3 5.5z" stroke="#9FD3FF" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/><path d="M21 18.5c0 .83-.67 1.5-1.5 1.5H18c-.55 0-1-.45-1-1V16.5c0-.83.67-1.5 1.5-1.5H20c1.66 0 3 1.34 3 3v0z" stroke="#9FD3FF" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/></svg>
              <a href="tel:+919346315298">+91 93463 15298</a>
            </li>

            <li>
              <svg className="icon" viewBox="0 0 24 24" width="18" height="18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 6.5h16v11a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-11z" stroke="#9FD3FF" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/><path d="M22 6.5l-10 7L2 6.5" stroke="#9FD3FF" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/></svg>
              <a href="mailto:bagayithiharish@gmail.com">bagayithiharish@gmail.com</a>
            </li>

            <li>
              <svg className="icon" viewBox="0 0 24 24" width="18" height="18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z" stroke="#9FD3FF" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/><circle cx="12" cy="9" r="2.2" fill="#9FD3FF"/></svg>
        ...
        <div className="footer-follow">
          ...
          <div className="socials">
            <a className="social-btn" href="https://www.linkedin.com/in/hareesh-ai-dev" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
      ...
      <div className="footer-bottom">
        <p>Designed & developed by <a href="#">HAREESH</a></p>
