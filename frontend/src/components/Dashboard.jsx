      ...
      <div className="dashboard-container">
        <div className="dashboard-header">
          ...
          <div className="header-actions">
            <button onClick={() => setChatOpen(true)} className="btn-open-chat" title="Open AI assistant">
              <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
                <path d="M12 2l1.7 4.9L19 8l-5.3 1.1L12 14l-1.7-4.9L5 8l5.3-1.1L12 2zm0 8l.9 2.6 2.6.9-2.6.9-.9 2.6-.9-2.6-2.6-.9 2.6-.9.9-2.6zM5 17l.8 2.2L8 20l-2.2.8L5 23l-.8-2.2L2 20l2.2-.8L5 17zm14 0l.8 2.2L22 20l-2.2.8L19 23l-.8-2.2L16 20l2.2-.8L19 17z"/>
              </svg>
              Ask AI
            </button>
            <button
          ...
          <div className="profile-info">
            ...
            <div className="profile-ask-ai-wrap">
              <p className="profile-ask-ai-label">
                <span className="profile-ask-ai-badge">
